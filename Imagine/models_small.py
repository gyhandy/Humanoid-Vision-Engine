...
class ShapeEncoder(nn.Module):
    def __init__(self, in_channels, out_channels=3):
        ...
        self.down1 = UNetDown(in_channels, 64, depth = 2, normalize=False)
        self.down2 = UNetDown(64, 128, depth = 3 )
        self.down3 = UNetDown(128, 256, depth = 3)
        self.down4 = UNetDown(256, 512, depth = 3, dropout=0.5)
...
class Decoder(nn.Module):
    def __init__(self, out_channels=3):
        ...
        self.up1 = UNetUp(512, 256, depth = 4, dropout=0.5)
        self.up2 = UNetUp(512, 128, depth = 4)
        self.up3 = UNetUp(256, 64, depth = 4)
    ...
    def forward(self, s_list, t_list, c_list):
        ...
        u1 = self.up1(d4, d3) # (512 --> 256) + 256 = 512
        u2 = self.up2(u1, d2) # (512 --> 128) + 128 = 256
        u3 = self.up3(u2, d1) # (256 --> 64) + 64 = 128
